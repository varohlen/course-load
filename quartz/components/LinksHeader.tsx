...
export default (() => {
  ...
  <div class="dropdown-content">
    <a href="/Biologi-1">Biologi 1</a>
    <a href="/Biologi-2">Biologi 2</a>
  </div>
</div>
<div class="dropdown">
  <a href="">
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3"/></svg>
            Matematik</a>
  <div class="dropdown-content">
    <a href="/Matematik-1a">Matematik 1a</a>
    <a href="/Matematik-2b">Matematik 2b</a>
  </div>
</div>
  ...
  <div class="dropdown-content">
    ...
    <a href="/Naturkunskap-2">Naturkunskap 2</a>
  </div>
</div> 
